...
class FleetVehicleLogContract(models.Model):
    ...
    additional_km_cost = fields.Monetary('Additional km', store=True, copy=True, digits='Product Price')
    returned_km_cost = fields.Monetary('Returned km', store=True, copy=True, digits='Product Price')
    ...
    @api.depends('contract_km','vehicle_id.odometer', 'vehicle_id.odometer_ids.value')
