...
class FleetVehicleLogContract(models.Model):
    ...
    additional_km_cost = fields.Float('Additional km', store=True, copy=True, digits=(3,3))
    returned_km_cost = fields.Float('Returned km', store=True, copy=True, digits=(3,3))
