...
#    def _get_shoes_pair_count(self):
    ...
    color_id = fields.Many2one('product.attribute.value', string='Color', store=True,
                               default=lambda self: self.company.color_attribute_id.id,
                               compute='get_sale_report_color')