...
class ShoesSaleReport(models.Model):
    ...
    def print_top_model_report(self):
        return self.env.ref(
            "shoes_dealer.0407.pnt_model_shoes_dealer_top_model_report"
        ).report_action(self)
    def print_top_manufacturer_report(self):
        return self.env.ref(
            "shoes_dealer.0407.pnt_model_shoes_dealer_top_manufacturer_report"
        ).report_action(self)

    def print_margin_report(self):
        return self.env.ref(
            "shoes_dealer.0407.pnt_model_shoes_dealer_margin_report"
        ).report_action(self)
